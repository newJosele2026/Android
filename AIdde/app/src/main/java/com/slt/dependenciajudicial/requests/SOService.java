package com.slt.dependenciajudicial.requests;
...
public interface SOService {
    ...
    Call<UsuarioDJModel> Authentication(@Field("tUserName") String tUserName,
                                        ...
                                        @Field("tVersionDispositivo") String tVersionDispositivo);
    ...
    @GET(ApiUtils.DIVIPOLA_LIST)
    Call<ListDivipolaModel> GetListDivipola();
