...
This command uses Ionic servers, so we require you to be logged into your free Ionic account. Use ${chalk_1.default.green('ionic login')} to login.
    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { RESOURCES, addResourcesToConfigXml, createImgDestinationDirectories, findMostSpecificSourceImage, getImageResources, getSourceImages, transformResourceImage, uploadSourceImage } = yield Promise.resolve().then(() => require('../../lib/integrations/cordova/resources'));
            if (!this.project) {
            ...
            yield this.checkForPlatformInstallation(platform, { promptToInstall: true });
            ...
            debug(`platforms=${platforms.map(e => chalk_1.default.bold(e)).join(', ')}`);
            ...
            debug(`${chalk_1.default.cyan('getProjectPlatforms')} completed: ${buildPlatforms.map(v => chalk_1.default.bold(v)).join(', ')}`);
