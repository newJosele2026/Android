    ...
    getMetadata() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return {
                ...
                description: `
This command reads and prints configuration values from the project's ${chalk_1.default.bold(constants_1.PROJECT_FILE)} file. It can also operate on the global CLI configuration (${chalk_1.default.bold('~/.ionic/config.json')}) using the ${chalk_1.default.green('--global')} option.
...
This command will sanitize config output for known sensitive fields (disabled when using ${chalk_1.default.green('--json')}).
      `,
                ...
                options: [
                    ...
                    {
                        name: 'root',
                        summary: `Operate on root of ${chalk_1.default.bold(constants_1.PROJECT_FILE)}`,
                        type: Boolean,
