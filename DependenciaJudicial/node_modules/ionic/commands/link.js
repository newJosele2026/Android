...
Ultimately, this command sets the ${chalk_1.default.bold('pro_id')} property in ${chalk_1.default.bold(constants_1.PROJECT_FILE)}, which marks this app as linked.
...
${chalk_1.default.cyan('[2]')}: ${chalk_1.default.bold('https://ionicframework.com/support/request')}
    ...
    createApp({ name }, runinfo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const appClient = yield this.getAppClient();
            const app = yield appClient.create({ name });
            yield this.linkApp(app, runinfo);
            return app.id;
        });
    }
