...
function loadExecutor(ctx, pargv, env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (!_executor) {
            const deps = yield lib_1.generateIonicEnvironment(ctx, pargv, env);
...
function run(pargv, env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        let executor;
        try {
            executor = yield loadExecutor(yield generateContext(), pargv, env);
        }
        catch (e) {
        ...
        if (pargv[0] !== '_') {
            try {
                ...
                if (foundCommand) {
                    ...
                    yield executor.execute(pargv, env);
                }
